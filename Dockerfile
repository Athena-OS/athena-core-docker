...
openssl \
athena-neofetch-config athena-nvim-config athena-powershell-config athena-config athena-tmux-config athena-vim-config athena-zsh cyber-toolkit htb-toolkit nist-feed
